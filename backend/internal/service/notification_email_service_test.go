...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "石头中转站", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "石头中转站", "https://example.com/reset", "en-US"))

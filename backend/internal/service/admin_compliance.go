...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 石头中转站 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the 石头中转站 Deployment and Operation Compliance Commitment"

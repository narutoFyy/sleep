export default {
  ...
  setup: {
    title: '石头中转站 Setup',
    description: 'Configure your 石头中转站 instance',
    database: {
  ...
  modelMarketplace: {
    ...
    description: 'Browse available models, context types, and effective pricing',
    bestPrice: 'Best price',
    allGroups: 'All groups',
    searchPlaceholder: 'Search models or platforms',
    models: '{count} models',
    channels: '{count} available groups',
    modelId: 'Model ID',
    copyId: 'Copy ID',
    copied: 'Copied',
    current: 'Current',
    ...
    loading: 'Loading models and pricing',
    loadFailed: 'Failed to load the model marketplace',
    refresh: 'Refresh model data',
    exchangeRecharge: 'Recharge rate',
    exchangeMarketplace: 'Marketplace value'
  },
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. 石头中转站-backups), choose a region',
    ...
    groups: {
      ...
      standby: {
        action: 'Standby',
        manage: 'Manage standby accounts',
        title: '{name} - Standby Accounts',
        role: 'Standby',
        addAccounts: 'Add Existing Accounts',
        createAccount: 'Create Account',
        searchAccounts: 'Search same-provider accounts...',
        noAvailableAccounts: 'No same-provider accounts are available',
        addSelected: 'Add Selected ({count})',
        configuredAccounts: 'Configured Standby Accounts',
        noConfiguredAccounts: 'No standby accounts configured',
        enabled: 'Enable Routing',
        priority: 'Priority',
        modelMappings: 'Model Mappings',
        addMapping: 'Add Mapping',
        requestModel: 'Requested Model',
        upstreamModel: 'Standby Upstream Model',
        testAccount: 'Test account connection',
        removeAccount: 'Remove from this group',
        unsupportedProvider: 'Standby accounts are supported for Anthropic and OpenAI groups only',
        saved: 'Standby configuration saved',
        loadFailed: 'Failed to load standby accounts',
        saveFailed: 'Failed to save standby configuration',
        testFailed: 'Account connection test failed',
        errors: {
          PRIORITY_INVALID: 'Priority must be an integer greater than 0',
          MAPPING_REQUIRED: 'At least one model mapping is required',
          MAPPING_FIELDS_REQUIRED: 'Requested and upstream models are required',
          MAPPING_DUPLICATE_PATTERN: 'Requested model patterns must be unique',
          MAPPING_PATTERN_INVALID: 'Requested model patterns may only use the * wildcard',
          MAPPING_SOURCE_PROVIDER_INVALID: 'Requested model must belong to the group provider',
          MAPPING_TARGET_PROVIDER_INVALID: 'Upstream model must belong to the group provider'
        }
      },
      platforms: {
        all: 'All Platforms',
    ...
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by 石头中转站, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within 石头中转站.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another 石头中转站 instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 石头中转站 end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 石头中转站 end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to 石头中转站',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">石头中转站 is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of 石头中转站, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {

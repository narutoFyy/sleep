...
import { mergeSelectedGroupMemberships } from '@/views/admin/groupStandby'
import {
...
const handleSubmit = async () => {
  ...
  updatePayload.account_groups = mergeSelectedGroupMemberships(props.account, form.group_ids)
